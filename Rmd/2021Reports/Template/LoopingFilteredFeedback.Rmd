...
ggplot() +
    ...
    labs(x = NULL, y = NULL,
         title = "Shifts in Educators' Confidence in Culture and Climate in the <br> <span style = 'color:#ff7b43;'>Diagnostic</span> and <span style = 'color:#00acf0;'>Follow-up<span> Surveys") +
    theme_bw() +
    theme(panel.border = element_blank(),
          legend.position = "none",
          plot.title = element_markdown(hjust = 0.5, family = "Calibri", size = 20, lineheight = 1.15),
...
table_maker(data = ela_gt, 
            column_names = colnames(data)[2:5], 
            title = "Educators’ ELA Content and Pedagogical Content Knowledge", 
...
ggplot() +
    ...
    labs(x = NULL, y = NULL,
         title = "Administrators Confidence in School Environment <br> <span style = 'color:#ff7b43;'>Diagnostic</span> and <span style = 'color:#00acf0;'>Follow-up<span> Surveys") +
    theme_bw() +
    theme(panel.border = element_blank(),
          legend.position = "none",
          plot.title = element_markdown(hjust = 0.5, family = "Calibri", size = 20, lineheight = 1.15),
...
teacher %>%
  ...
  tab_header(html("<strong>% of coaches, leaders, or administrators that always or<br> almost always observe the teaching practice")) %>%
  fmt_percent(
    columns = c(1, 2),
    scale_values = F,
    decimals = 0
...
lableader_df %>%
  ...
  labs(x = "",
       y = "",
       title = "<span style = 'color:#00acf0;'>Lab Leaders Engagement</span>",
       fill = "") +
  scale_y_continuous(labels = percent_format(scale = 1), expand = c(0.03, 0), limits = c(0, 100)) +
  scale_x_discrete(expand = c(-0.9, 0)) +
  scale_fill_manual(values = tl_palette(color = "blue", n = 4, theme = "dark")) +
  scale_color_manual(values = tl_palette(color = "blue", n = 4, theme = "dark")) +
  coord_flip() +
  theme_tl() +
