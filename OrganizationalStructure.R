...
(org_structure <- highchart() %>%
  ...
  hc_add_series( # Data
    ...
    nodes = list(
      ...
      list(offset = -990, width = 300, id = 'CFO', title = 'Interim CFO', name = "Daissan Colbert", color = "#ff89ff", image = 'https://wellesleysocietyofartists.org/wp-content/uploads/2015/11/image-not-found.jpg'),
      ...
      list(id = 'People Ops', title = 'M, People Ops', name = "Melissa Ramos", color = "#007ad0", image = 'https://wellesleysocietyofartists.org/wp-content/uploads/2015/11/image-not-found.jpg'),
      ...
      list(layout = "hanging", id = 'Data Analyst', title = 'Data Analyst', name = "Duncan Gates", color = "#007ad0", image = 'https://wellesleysocietyofartists.org/wp-content/uploads/2015/11/image-not-found.jpg'),
      ...
      list(layout = "hanging", id = "P14", title = "M, Partnerships", name = "Jasmin Porter", color = "#007ad0", image = 'https://wellesleysocietyofartists.org/wp-content/uploads/2015/11/image-not-found.jpg'),
      ...
      list(layout = "hanging", id = "P16", title = "M, Partnerships", name = "Tara McDonald", color = "#007ad0", image = 'https://wellesleysocietyofartists.org/wp-content/uploads/2015/11/image-not-found.jpg'),
      list(layout = "hanging", id = "P21", title = "M, Partnerships", name = "Monica Moton", color = "#007ad0", image = 'https://wellesleysocietyofartists.org/wp-content/uploads/2015/11/image-not-found.jpg'),
      list(layout = "hanging", id = "P22", title = "M, Partnerships", name = "Nadalee Williams", color = "#007ad0", image = 'https://wellesleysocietyofartists.org/wp-content/uploads/2015/11/image-not-found.jpg'),
      ...
      list(layout = "hanging", id = "CD23", title = "M, Content Design", name = "TBH", color = "#49b3a7", image = 'https://wellesleysocietyofartists.org/wp-content/uploads/2015/11/image-not-found.jpg'),
      ...
      list(layout = "hanging", id = "SLP1", title = "M, Partnerships", name = "Lindsay Romano", color = "#007ad0", image = 'https://wellesleysocietyofartists.org/wp-content/uploads/2015/11/image-not-found.jpg'),
      list(layout = "hanging", id = "SLP2", title = "M, Partnerships", name = "Cara Gromm", color = "#007ad0", image = 'https://wellesleysocietyofartists.org/wp-content/uploads/2015/11/image-not-found.jpg'),
