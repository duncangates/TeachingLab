...
info_page <- div(
  ...
  div(
    ...
    div(
      ...
      br(),
      p(
        "The highlighting simply indicates the 3 most frequent words in the particular extracted data",
      ...
      br(),
      p(
        "Lastly there are downloadable reports that include all of the above features, as well as summary statements",
