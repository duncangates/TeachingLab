...
math_courses_in_sheet[which(math_courses_in_sheet %!in% math_courses_in_course_survey == FALSE)] %>%
  clipr::write_clip() -> math_course_diff
math_courses_in_sheet[which(math_courses_in_sheet %!in% math_courses_in_session_survey == FALSE)] %>%
