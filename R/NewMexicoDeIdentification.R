...
district_replace_list3 <- c("Clovis Municipal Schools" = "district1", "Albuquerque Public Schools" = "district2", "School of Dreams Academy \\(State Charter\\)" = "district3", "Amy Biehl Charter High School \\(State Charter\\)" = "district5", "Raton Public Schools" = "district6", "Roswell Independent Schools District" = "district7", "Sandoval Academy of Bilingual Education \\(State Charter\\)" = "district8", "Peñasco Independent School District" = "district9", "Robert F. Kennedy Charter School \\(Local Charter\\)" = "district11", "La Academia Dolores Huerta \\(State Charter\\)" = "district12", "Dora Consolidated Schools" = "district13", "Springer Municipal Schools" = "district14")
