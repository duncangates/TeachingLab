...
```{r collaboration}
agree_vector <- c("3", "4", "4 or more times", "4 or more")
...
fall_averages_ela <- fall_df %>%
  ...
  select(93:99) %>%
  summarise(
    pre1 = c(sum(pre45a %in% agree_vector, na.rm = T)/length(pre45a), length(pre45a)),
    pre2 = c(sum(pre45b %in% agree_vector, na.rm = T)/length(pre45b), length(pre45b)),
    pre3 = c(sum(pre45c %in% agree_vector, na.rm = T)/length(pre45c), length(pre45c)),
    pre4 = c(sum(pre45d %in% agree_vector, na.rm = T)/length(pre45d), length(pre45d)),
    pre5 = c(sum(pre45e %in% agree_vector, na.rm = T)/length(pre45e), length(pre45e)),
    pre6 = c(sum(pre45f %in% agree_vector, na.rm = T)/length(pre45f), length(pre45f)),
    pre7 = c(sum(pre45g %in% agree_vector, na.rm = T)/length(pre45g), length(pre45g))) %>%
  dplyr::mutate(across(everything(), ~ .x * 100))
...
spring_averages_ela <- spring_df %>%
  ...
  select(83:89) %>%
  summarise(
    post1 = c(sum(post45a %in% agree_vector, na.rm = T)/length(post45a), length(post45a)),
    post2 = c(sum(post45b %in% agree_vector, na.rm = T)/length(post45b), length(post45b)),
    post3 = c(sum(post45c %in% agree_vector, na.rm = T)/length(post45c), length(post45c)),
    post4 = c(sum(post45d %in% agree_vector, na.rm = T)/length(post45d), length(post45d)),
    post5 = c(sum(post45e %in% agree_vector, na.rm = T)/length(post45e), length(post45e)),
    post6 = c(sum(post45f %in% agree_vector, na.rm = T)/length(post45f), length(post45f)),
    post7 = c(sum(post45g %in% agree_vector, na.rm = T)/length(post45g), length(post45g))) %>%
  dplyr::mutate(across(everything(), ~ .x * 100))
...
joined_increase <- left_join(fall_join, spring_join, by = "id") %>%
  ...
  summarise(sum(increase45a, na.rm = T)/143,
            sum(increase45b, na.rm = T)/143,
            sum(increase45c, na.rm = T)/143,
            sum(increase45d, na.rm = T)/143,
            sum(increase45e, na.rm = T)/143,
            sum(increase45f, na.rm = T)/143,
            sum(increase45g, na.rm = T)/143) %>%
  mutate_all( ~ .x * 100)
...
fall_averages_ela <- fall_df %>%
  ...
  select(100:105) %>%
  summarise(
    pre1 = c(sum(pre46a %in% agree_vector, na.rm = T)/length(pre46a), length(pre46a)),
    pre2 = c(sum(pre46b %in% agree_vector, na.rm = T)/length(pre46b), length(pre46b)),
    pre3 = c(sum(pre46c %in% agree_vector, na.rm = T)/length(pre46c), length(pre46c)),
    pre4 = c(sum(pre46d %in% agree_vector, na.rm = T)/length(pre46d), length(pre46d)),
    pre5 = c(sum(pre46e %in% agree_vector, na.rm = T)/length(pre46e), length(pre46e)),
    pre6 = c(sum(pre46f %in% agree_vector, na.rm = T)/length(pre46f), length(pre46f))) %>%
  dplyr::mutate(across(everything(), ~ .x * 100))
...
spring_averages_ela <- spring_df %>%
  ...
  select(90:95) %>%
  summarise(
    post1 = c(sum(post46a %in% agree_vector, na.rm = T)/length(post46a), length(post46a)),
    post2 = c(sum(post46b %in% agree_vector, na.rm = T)/length(post46b), length(post46b)),
    post3 = c(sum(post46c %in% agree_vector, na.rm = T)/length(post46c), length(post46c)),
    post4 = c(sum(post46d %in% agree_vector, na.rm = T)/length(post46d), length(post46d)),
    post5 = c(sum(post46e %in% agree_vector, na.rm = T)/length(post46e), length(post46e)),
    post6 = c(sum(post46f %in% agree_vector, na.rm = T)/length(post46f), length(post46f))) %>%
  dplyr::mutate(across(everything(), ~ .x * 100))
...
fall_averages_ela <- fall_df %>%
  ...
  select(106:111) %>%
  summarise(
    pre47 = c(sum(pre47 %in% agree_vector, na.rm = T)/length(pre47), length(pre47)),
    pre48 = c(sum(pre48 %in% agree_vector, na.rm = T)/length(pre48), length(pre48)),
    pre49 = c(sum(pre49 %in% agree_vector, na.rm = T)/length(pre49), length(pre49)),
    pre50 = c(sum(pre50 %in% agree_vector, na.rm = T)/length(pre50), length(pre50)),
    pre51 = c(sum(pre51 %in% agree_vector, na.rm = T)/length(pre51), length(pre51)),
    pre52 = c(sum(pre52 %in% agree_vector, na.rm = T)/length(pre52), length(pre52))) %>%
  dplyr::mutate(across(everything(), ~ .x * 100))
...
spring_averages_ela <- spring_df %>%
  ...
  select(96:101) %>%
  summarise(
    post47 = c(sum(post47 %in% agree_vector, na.rm = T)/length(post47), length(post47)),
    post48 = c(sum(post48 %in% agree_vector, na.rm = T)/length(post48), length(post48)),
    post49 = c(sum(post49 %in% agree_vector, na.rm = T)/length(post49), length(post49)),
    post50 = c(sum(post50 %in% agree_vector, na.rm = T)/length(post50), length(post50)),
    post51 = c(sum(post51 %in% agree_vector, na.rm = T)/length(post51), length(post51)),
    post52 = c(sum(post52 %in% agree_vector, na.rm = T)/length(post52), length(post52))) %>%
  dplyr::mutate(across(everything(), ~ .x * 100))
...
joined_increase <- left_join(fall_join, spring_join, by = "id") %>%
  ...
  summarise(sum(increase47, na.rm = T)/9,
            sum(increase48, na.rm = T)/9,
            sum(increase49, na.rm = T)/9,
            sum(increase50, na.rm = T)/9,
            sum(increase51, na.rm = T)/9,
            sum(increase52, na.rm = T)/9) %>%
  mutate_all( ~ .x * 100)
