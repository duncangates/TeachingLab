...
n <- course_survey %>%
        dplyr::filter(date_created >= as.Date("2021-08-01") & date_created < as.Date("2021-09-01")) %>%
        dplyr::filter(., `Select your site (district, parish, network, or school).` == "San Diego Unified School District") %>%
