...
setdiff(ela_courses_in_course_survey, ela_courses_in_sheet) %>%
  clipr::write_clip() -> ela_course_diff
setdiff(ela_courses_in_session_survey, ela_courses_in_sheet) %>%
...
setdiff(math_courses_in_course_survey, math_courses_in_sheet) %>%
  clipr::write_clip() -> math_course_diff
setdiff(math_courses_in_session_survey, math_courses_in_sheet) %>%
...
setdiff(school_leaders_courses_in_course_survey, school_leaders_courses_in_sheet) %>%
  clipr::write_clip() -> school_leaders_course_diff
setdiff(school_leaders_courses_in_session_survey, school_leaders_courses_in_sheet) %>%
...
setdiff(hqim_fellowship_courses_in_course_survey, hqim_fellowship_courses_in_sheet) %>%
  clipr::write_clip() -> hqim_fellowship_course_diff
setdiff(hqim_fellowship_courses_in_session_survey, hqim_fellowship_courses_in_sheet) %>%
...
setdiff(hqpl_fellowship_courses_in_course_survey, hqpl_fellowship_courses_in_sheet) %>%
  clipr::write_clip() -> hqpl_fellowship_course_diff
setdiff(hqpl_fellowship_courses_in_session_survey, hqpl_fellowship_courses_in_sheet) %>%
...
setdiff(lab_leaders_courses_in_course_survey, lab_leaders_courses_in_sheet) %>%
  clipr::write_clip() -> lab_leaders_course_diff
setdiff(lab_leaders_courses_in_session_survey, lab_leaders_courses_in_sheet) %>%
...
setdiff(state_level_courses_in_course_survey, state_level_courses_in_sheet) %>%
  clipr::write_clip() -> state_level_course_diff
setdiff(state_level_courses_in_session_survey, state_level_courses_in_sheet) %>%
