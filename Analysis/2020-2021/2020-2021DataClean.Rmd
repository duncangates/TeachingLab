...
rename_vector <- c("mathgen1a...47" = "mathgen1a.x",
                   ...
                   "mathgen1a...142" ="mathgen1a.y",
                   "mathgen1b...143" ="mathgen1b.y", 
                   "mathgen1c...144" ="mathgen1c.y", 
                   "mathgen1d...145" ="mathgen1d.y", 
                   "mathgen2...146" ="mathgen2.y", 
                   "mathgen3a...147" ="mathgen3a.y", 
                   "mathgen3b...148" ="mathgen3b.y",
                   "mathgen3c...149" ="mathgen3c.y", 
                   "mathgen3d...150" ="mathgen3d.y", 
                   "matheq1...151" ="matheq1.y", 
                   "matheq2a...152" ="matheq2a.y",
                   "matheq2b...153" ="matheq2b.y", 
                   "matheq2c...154" ="matheq2c.y", 
                   "matheq2d...155" ="matheq2d.y",
                   "mathsupp1...156" ="mathsupp1.y", 
                   "mathsupp2a...157" ="mathsupp2a.y",
                   "mathsupp2b...158" ="mathsupp2b.y", 
                   "mathsupp2c...159" ="mathsupp2c.y", 
                   "mathsupp2d...160" ="mathsupp2d.y", 
                   "matheff1a...161" ="matheff1a.y", 
                   "matheff1b...162" ="matheff1b.y", 
                   "matheff1c...163" ="matheff1c.y", 
                   "matheff1d...164" ="matheff1d.y", 
                   "matheff2...165" ="matheff2.y", 
                   "matheq3...166" ="matheq3.y", 
                   "matheff3...167" ="matheff3.y")

matched_2021 <- bind_cols(fall_one %>% arrange(id), spring_one %>% arrange(id) %>% select(-id)) %>%
  rename_with( ~ str_replace_all(.x, rename_vector)) %>%
  mutate(pre_site = str_replace_all(pre_site, loc_rename)) %>%
  mutate(post_site = str_replace_all(post_site, loc_rename)) %>%
  mutate(pre_site = post_site)
