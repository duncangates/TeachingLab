...
replacement_vector <- c(
  "Clovis High School" = "school1", "Taylor Middle School" = "school2", "School of Dreams Academy" = "school3", "Curriculum and Instruction" = "school4", "Amy Biehl Charter High School" = "school5", "Raton Intermediate School" = "school6", "Mesa Middle School" = "school7", "Sandoval Academy of Bilingual Education" = "school8", "Peñasco Middle and High School" = "school9", "District Office/District Resource Teachers" = "school10", "Robert F. Kennedy Charter School (Local Charter)" = "school11", "La Academia Dolores Huerta" = "school12", "Dora Elementary" = "school13", "Forrester Elementary" = "school14", "Wilferth Elementary" = "school15", "Christine Duncan Heritage Academy" = "school17"
)

district_list <- c("Clovis Municipal Schools", "Albuquerque Public Schools", "School of Dreams Academy (State Charter)", 
                   "Albuquerque Public Schools", "Amy Biehl Charter High School (State Charter)", 
                   "Raton Public Schools", "Roswell Independent Schools District", 
...
district_replace_list3 <- c("Clovis Municipal Schools" = "district1", "Albuquerque Public Schools" = "district2", "School of Dreams Academy \\(State Charter\\)" = "district3", "Amy Biehl Charter High School \\(State Charter\\)" = "district5", "Raton Public Schools" = "district6", "Roswell Independent Schools District" = "district7", "Sandoval Academy of Bilingual Education \\(State Charter\\)" = "district8", "Peñasco Independent School District" = "district9", "Robert F. Kennedy Charter School \\(Local Charter\\)" = "district11", "La Academia Dolores Huerta \\(State Charter\\)" = "district12", "Dora Consolidated Schools" = "district13", "Springer Municipal Schools" = "district14", "Christine Duncan Heritage Academy (Local Charter)" = "district15")
...
teachers_deidentified <- teachers_english %>%
  distinct()
